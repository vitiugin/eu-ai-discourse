...
umap_model = UMAP(n_neighbors=5, n_components=5, min_dist=0.6, metric='cosine', random_state=13) # https://maartengr.github.io/BERTopic/getting_started/dim_reduction/dim_reduction.html

topic_model = BERTopic(nr_topics=len(seed_topic_list), umap_model=umap_model, vectorizer_model=vectorizer_model, 
